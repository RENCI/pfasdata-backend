...
from .serializers import ahhs_dust_data_Serializer, ahhs_water_data_Serializer, ncserum_Serializer, pfas_in_tapwater_usgs_Serializer, pfas_sample_data_Serializer, ntar_sample_data_Serializer
from .models import ahhs_dust_data, ahhs_water_data, ncserum, pfas_in_tapwater_usgs, pfas_sample_data, ntar_sample_data
...
class podm_ahhs_dust_data_View(viewsets.ModelViewSet):
...
class podm_ahhs_water_data_View(viewsets.ModelViewSet):
    pagination_class = CustomPageNumberPagination
...
class podm_ncserum_View(viewsets.ModelViewSet):
    pagination_class = CustomPageNumberPagination
...
class podm_ntar_sample_data_View(viewsets.ModelViewSet):
    ...
    filter_backends = [DjangoFilterBackend]
    filter_fields = ['sample_id', 'sample', 'study', 'pi', 'units', 'medium', 'city', 'state', 'zipcode', 'pfas_short_name', 'pfas_long_name', 'flags', 'measurement']
