...
class podm_ntar_sample_data_View(viewsets.ModelViewSet):
    ...
    filter_backends = [DjangoFilterBackend, OrderingFilter]
    filter_fields = ['sample_id', 'study', 'pi', 'units', 'medium', 'city', 'state', 'zipcode', 'station', 'site_type', 'sample_detects', 'sample_sum', 'pfas_short_name', 'pfas_long_name', 'flags', 'measurement']
    ordering_fields = ['city', 'state', 'station', 'site_type']
