...
from .serializers import pfas_name_classification_info_Serializer, pfas_in_tapwater_usgs_Serializer, pfas_sample_data_Serializer, ntar_sample_data_Serializer
...
class podm_ntar_sample_data_View(viewsets.ModelViewSet):
    ...
    filter_backends = [DjangoFilterBackend, OrderingFilter]
    filter_fields = ['sample_id', 'study', 'pi', 'units', 'medium', 'city', 'state', 'zipcode', 'station', 'site_type', 'latitude', 'longitude', 'sample_detects', 'sample_sum', 'pfas_short_name', 'pfas_long_name', 'flags', 'measurement']
    ordering_fields = ['city', 'state', 'station', 'site_type', 'latitude', 'longitude']
